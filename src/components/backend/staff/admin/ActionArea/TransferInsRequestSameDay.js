...
const TransferInsRequestSameDay=()=>{
     ...
     useEffect(()=>{
        ...
        getAllTransferInsSameDay();
        // console.log('fetch api');

    },[0]);
     const  getAllTransferInsSameDay=()=>{
...
export default TransferInsRequestSameDay