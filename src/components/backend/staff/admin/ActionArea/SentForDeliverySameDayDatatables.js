...
import {sentForDeliverySameDay} from "../../../../../redux/actions/BranchOperation";
import {useHistory} from "react-router-dom";

const SentForDeliveryDatatablesSameDay=()=>{
          ...
          sort: true,
             customBodyRender: (value, tableMeta, updateValue) => (
              <>
                  ...
                  <div style={{cursor:'pointer'}} onDoubleClick={(event)=> getPickupDetail(sentForDeliveriesSameDay[tableMeta.rowIndex].id)}>{value}</div>
              </>
          )
         }
        },
...
export default SentForDeliveryDatatablesSameDay