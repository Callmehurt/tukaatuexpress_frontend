...
const HoldMoveWarehouseModal=(props)=>{
    const toggle = props.toggle;
     ...
     const[moveHoldPickupId,setMoveHoldPickupId]=useState('');
     const [holdMoveWarehouseData, setHoldMoveWarehouseData] = useState({
         pickup_id:'',
         remarks:''
     ...
     useEffect( ()=>{
        ...
        console.log(props);
         getMoveHoldPacketId(props.packetId);
         console.log(moveHoldPickupId);

    },[props.packetId]);
      const getMoveHoldPacketId=(data)=>{
        setMoveHoldPickupId(data);
    }

   const selectChange = event => {
       if(event){
            const field = {...holdMoveWarehouseData};
            field.remarks = event.target.value;
             field.pickup_id = moveHoldPickupId;
            setHoldMoveWarehouseData(field);
    ...
    const  getAllHoldSameDay=()=>{
     ...
     const onSubmit = async (event) => {
         ...
         console.log(moveHoldPickupId);
          console.log(holdMoveWarehouseData);
         axios.post('/admin/pickup/move/warehouse' ,holdMoveWarehouseData)
             .then((res) => {
                 console.log(res);
...
export default HoldMoveWarehouseModal