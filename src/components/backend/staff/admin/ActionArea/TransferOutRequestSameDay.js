...
import {TransferInsSameDay, TransferOutsCount} from "../../../../../redux/actions/Trasnfer";
import{useDispatch,useSelector} from "react-redux";
import {useHistory} from "react-router-dom";

const TransferOutRequestSameDay=()=>{
    ...
    return(
        <>
            ...
            <MUIDataTable
             // title={<><div style={{fontSize:'16px', fontWeight:'500',}}>Incoming Request Same Day</div></>}
            data={transferOutListSameDay}
            columns={columns}
            options={options}
           />
        </>
...
export default TransferOutRequestSameDay