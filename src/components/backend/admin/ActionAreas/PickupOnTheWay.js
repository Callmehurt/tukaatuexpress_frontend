...
import {pickupsOnTheWayList} from './../../../../redux/actions/MainAdmin'
import {useDispatch, useSelector} from "react-redux";

const PickupOnTheWay=()=>{
      const dispatch = useDispatch();
      const thisState = useSelector((state) => state.mainAdmin);
    const pickupOnTheWayList = thisState.pickupOnTheWayList;
    useEffect(()=>{
    ...
    const getOnWayList=()=>{
        axios.get('/mainadmin/pickup/warehouse/list')
            .then((res) => {
                ...
                dispatch(pickupsOnTheWayList(res.data));
