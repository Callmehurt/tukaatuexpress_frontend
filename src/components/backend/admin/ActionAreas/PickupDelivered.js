...
import {pickupsDeliveredList} from './../../../../redux/actions/MainAdmin'
import {useDispatch, useSelector} from "react-redux";

const PickupDelivered=()=>{
     const dispatch = useDispatch();
     const thisState = useSelector((state) => state.mainAdmin);
    const pickupDeliveredList = thisState.pickupDeliveredList;
    useEffect(()=>{
    ...
    const getDeliveredList=()=>{
         axios.get('/mainadmin/pickup/delivered/list')
            .then((res) => {
                console.log(res);
                // console.log('warehouseList');
                // console.log(res.data);
                dispatch(pickupsDeliveredList(res.data))
...
export default PickupDelivered